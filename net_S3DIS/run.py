...
parser.add_argument('--data_path', type=str, default='/mnt/cm-nas03/backup/students/qbai/Datasets/point_clouds/Hannover_AreaMapping_4_labeled_feat_type_h5', help='data path')
...
parser.add_argument('--use_lidar', type=bool, default=False, help='Whether to use intensity feature')
...
graph_inf = {'stride_list': [4, 4, 4, 2], #can be seen as the downsampling rate
             'radius_list': [0.7, 1.4, 2.8, 5.6, 11.2], # radius for neighbor points searching
